...
export default {
  ...
  mounted() {
    document.title = 'Freesets | Typography';
  }
};
</script>
<script setup>
...
const url = 'https://79d87a1f9ee388f6.mokky.dev/typography';
...
<template>
  ...
  >
    <a
      href="#"
      type="button"
      class="relative flex gap-2 items-center px-10 py-1.5 bg-[#ffaa1b] rounded-b-[20px]"
    >
      <img src="/headIcon/typography.svg" alt="" class="w-6" />
      <h2 class="text-[17px] font-semibold">
        Typography <span class="text-[15px] font-semibold">(23)</span>
      </h2>
    </a>
  </div>
    ...
    <div class="">
      ...
      >
        <div
          ...
          class="rounded-lg group ring-zinc-700 ring-2 hover:ring-[#ffaa1b] transition-all"
        >

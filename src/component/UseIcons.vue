...
<template>
  ...
  >
    <a
      href="#"
      type="button"
      class="relative flex gap-2 items-center px-10 py-1.5 bg-[#2b6dff] rounded-b-[20px]"
    >
      <img src="/headIcon/icons.svg" alt="" class="w-6" />
      <h2 class="text-[17px] font-semibold">
        Icons <span class="text-[15px] font-semibold">(42)</span>
      </h2>
    </a>
  </div>
    ...
    <div class="">
      <div class="mt-[31px] flex place-content-center mx-auto">
        <input
          type="text"
          v-model="searchQuery"
          class="p-3 border-2 w-[300px] rounded-xl border-zinc-700"
          placeholder="Search icons"
        />
      </div>
      <div
        class="grid xl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-5 px-6 mt-[51px]"
      >
        <div

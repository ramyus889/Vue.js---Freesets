...
export default {
  ...
  mounted() {
    document.title = 'Freesets | Backgrounds';
  }
};
</script>
<script setup>
...
const url = 'https://79d87a1f9ee388f6.mokky.dev/backgrounds';
...
<template>
  ...
  >
    <a
      href="#"
      type="button"
      class="relative flex gap-2 items-center px-10 py-1.5 bg-[#5345f7] rounded-b-[20px]"
    >
      <img src="/headIcon/backgrounds.svg" alt="" class="w-6" />
      <h2 class="text-[17px] font-semibold">
        Backgrounds <span class="text-[15px] font-semibold">(28)</span>
      </h2>
    </a>
  </div>
    ...
    <div class="">
      ...
      >
        <div
          ...
          class="rounded-lg group ring-zinc-700 ring-2 hover:ring-[#5345f7] transition-all"
        >

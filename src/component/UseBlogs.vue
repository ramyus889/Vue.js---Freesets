...
<template>
  ...
  >
    <a
      href="#"
      type="button"
      class="relative flex gap-2 items-center px-10 py-1.5 bg-[#00a1ff] rounded-b-[20px]"
    >
      <img src="/headIcon/blogs.svg" alt="" class="w-6" />
      <h2 class="text-[17px] font-semibold">
        Blogs <span class="text-[15px] font-semibold">(24)</span>
      </h2>
    </a>
  </div>

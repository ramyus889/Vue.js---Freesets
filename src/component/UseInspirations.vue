...
export default {
  ...
  mounted() {
    document.title = 'Freesets | Inspirations';
  }
};
</script>
<script setup>
...
const url = 'https://79d87a1f9ee388f6.mokky.dev/inspirations';
    ...
    <div class="">
      ...
      <div class="grid xl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-5 mt-[20px]">
        <div
          ...
          class="rounded-lg group ring-zinc-700 ring-2 hover:ring-[#6366f1] transition-all"
        >

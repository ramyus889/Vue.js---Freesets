...
const url = 'https://79d87a1f9ee388f6.mokky.dev/tools';
...
<template>
  ...
  >
    <a
      href="#"
      type="button"
      class="relative flex gap-2 items-center px-10 py-1.5 bg-[#f97316] rounded-b-[20px]"
    >
      <img src="/headIcon/tools.svg" alt="" class="w-6" />
      <h2 class="text-[17px] font-semibold">
        Tools <span class="text-[15px] font-semibold">(27)</span>
      </h2>
    </a>
  </div>
    ...
    <div class="">
      ...
      <div class="grid xl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-5 mt-[20px]">
        <div
          ...
          class="rounded-lg group ring-zinc-700 ring-2 hover:ring-[#f97316] transition-all"
        >

...
const url = 'https://79d87a1f9ee388f6.mokky.dev/Use3d';
...
<template>
  ...
  >
    <a
      href="#"
      type="button"
      class="relative flex gap-2 items-center px-10 py-1.5 bg-[#8935ff] rounded-b-[20px]"
    >
    ...
    <div class="">
      ...
      <div class="grid xl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-5 mt-[20px]">
        <div
          ...
          class="rounded-lg group ring-zinc-700 ring-2 hover:ring-[#8935ff] transition-all"
        >

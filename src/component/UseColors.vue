...
export default {
  ...
  mounted() {
    document.title = 'Freesets | Colors';
  }
};
</script>
<script setup>
...
const url = 'https://79d87a1f9ee388f6.mokky.dev/colors';
...
<template>
  ...
  >
    <a
      href="#"
      type="button"
      class="relative flex gap-2 items-center px-10 py-1.5 bg-[#ff36a2] rounded-b-[20px]"
    >
      <img src="/headIcon/colors.svg" alt="" class="w-6" />
      <h2 class="text-[17px] font-semibold">
        Colors <span class="text-[15px] font-semibold">(20)</span>
      </h2>
    </a>
  </div>
    ...
    <div class="">
      ...
      <div class="grid xl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-5 mt-[20px]">
        <div
          ...
          class="rounded-lg group ring-zinc-700 ring-2 hover:ring-[#ff36a2] transition-all"
        >

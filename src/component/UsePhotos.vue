...
export default {
  ...
  mounted() {
    document.title = 'Freesets | Photos';
  }
};
</script>
<script setup>
...
const url = 'https://79d87a1f9ee388f6.mokky.dev/photos';
...
<template>
  ...
  >
    <a
      href="#"
      type="button"
      class="relative flex gap-2 items-center px-10 py-1.5 bg-[#d41cf1] rounded-b-[20px]"
    >
      <img src="/headIcon/photos.svg" alt="" class="w-6" />
      <h2 class="text-[17px] font-semibold">
        Photos <span class="text-[15px] font-semibold">(23)</span>
      </h2>
    </a>
  </div>
